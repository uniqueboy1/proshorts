...
import 'package:pro_shorts/admin/getx/get_view_video.dart';
...
class ViewVideo extends StatefulWidget {
  ...
  const ViewVideo({Key? key, required this.videoId}) : super(key: key);
...
class _ViewVideoState extends State<ViewVideo> {
  ViewVideoController ownVideoController = Get.put(ViewVideoController());
